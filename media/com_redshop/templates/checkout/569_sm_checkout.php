...
{attribute_price_without_vat}</td>
...
<div class="row">
<div class="col-sm-6">
<div class="form-group cart_customer_note"><label>{customer_note_lbl}:</label> {customer_note}</div>
<div class="form-group cart_requisition_number"><label>{requisition_number_lbl}:</label> {requisition_number}</div>
</div>
<div class="col-sm-6">
<div class="redshop-login form-horizontal">
<div class="form-group">
<div class="row"><label class="col-sm-6">{product_subtotal_excl_vat_lbl}:</label>
<div class="col-sm-6">{product_subtotal_excl_vat}</div>
</div>
</div>
<!-- {if discount}-->
<div class="form-group">
<div class="row"><label class="col-sm-6">{discount_lbl}:</label>
<div class="col-sm-6">{discount}</div>
</div>
</div>
<!-- {discount end if}-->
<div class="form-group">
<div class="row"><label class="col-sm-6">{shipping_with_vat_lbl}:</label>
...
<!-- {if vat}-->
<div class="form-group">
<div class="row"><label class="col-sm-6">{vat_lbl}:</label>
<div class="col-sm-6">{tax}</div>
</div>
</div>
<!-- {vat end if} --> <!-- {if payment_discount}-->
<div class="form-group">
<div class="row"><label class="col-sm-6">{payment_discount_lbl}:</label>
<div class="col-sm-6">{payment_order_discount}</div>
</div>
</div>
<!-- {payment_discount end if}-->
<div class="form-group total">
<div class="row"><label class="col-sm-6">{total_lbl}:</label>
...
<div class="row">
<div class="col-sm-12">
<div class="checkbox"><label class="checkbox">{newsletter_signup_chk}{newsletter_signup_lbl}</label></div>
