...
<div class="product_s_desc_box"><span>Description: </span>{product_s_desc}</div>
<div class="product_full_desc_box"><span>Description: </span>{product_desc}
<div class="pro_brand"><span>Brand:</span>{rs_brand}</div>
<div class="pro_material"><span>Material:</span>{rs_material}</div>
<div class="pro_catalog"><span>Catalogue:</span>{rs_catalog_download}</div>
</div>
</div>
<div class="prod-stock"><label>Availability: </label>
