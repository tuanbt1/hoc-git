...
class JFormFieldBrowserCompatibility extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html .= '<table class="wright-browser-table"><tr><th>' . JText::_('TPL_REDSHOEMANIAC_BROWSER_COMPATIBILITY_BROWSER') . '</th><th>' . JText::_('TPL_REDSHOEMANIAC_BROWSER_COMPATIBILITY_MINIMUM_VERSION') . '</th><th>' . JText::_('TPL_REDSHOEMANIAC_BROWSER_COMPATIBILITY_DESKTOP') . '</th><th>' . JText::_('TPL_REDSHOEMANIAC_BROWSER_COMPATIBILITY_RECOMMENDED') . '</th><th>' . JText::_('TPL_REDSHOEMANIAC_BROWSER_COMPATIBILITY_MOBILE') . '</th></tr>';
