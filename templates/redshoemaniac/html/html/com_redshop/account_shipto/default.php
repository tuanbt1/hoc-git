...
<div class='account-tab'>
	<ul class="tabs nav nav-tabs">
		<li class="tab-link" data-tab="tab-1"><a href='?option=com_redshop&view=account&Itemid=<?php echo $_GET['Itemid'];?>'>CONTACT INFO</a></li>
		<li class="tab-link active" data-tab="tab-2"><a href='?option=com_redshop&view=account_shipto&Itemid=<?php echo $_GET['Itemid'];?>'>SHIPPING INFO</a></li>
		<li class="tab-link" data-tab="tab-3"><a href='?option=com_redshop&view=orders&Itemid=<?php echo $_GET['Itemid'];?>'>MY ORDERS</a></li>
	</ul>
</div>
<fieldset class="adminform acc_shipto">
	<div class='title-shipto'>
	...
	<div class='btn-shipto'>
		<a class='acc_shipto_back' href="<?php echo JRoute::_($backlink); ?>">
						<?php echo JText::_('COM_REDSHOP_BACK'); ?></a>
		<a class='acc_shipto_add' href="<?php echo JRoute::_($add_addlink); ?>">
