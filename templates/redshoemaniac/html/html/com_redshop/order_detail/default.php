...
$print_tag .= "<img src='".JURI::base()."templates/".$template."/images/icon-print.png' alt='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' />";
$print_tag .= "</a>";
...
if (strstr($orderslist_template, "{noid}"))
{
	$search []  = "{noid}";
	$replace [] = $oid;
}
if (strstr($orderslist_template, "{username}"))
{
	$search []  = "{username}";
