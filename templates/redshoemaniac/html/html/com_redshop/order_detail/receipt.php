...
?>
<div class="checkout-bar bar-3-active">
	<ul>
	<li class="checkout-bar-1"><?php echo JText::_('COM_REDSHOP_ORDER_INFORMATION');?></li>
	<li class="checkout-bar-2"><?php echo JText::_('COM_REDSHOP_PAYMENT');?></li>
	<li class="checkout-bar-3-active"><?php echo JText::_('COM_REDSHOP_RECEIPT'); ?></li>
	</ul>
</div>
<?php
...
$print_tag = "<a class='printicon' " . $onclick . " title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "'>";
$print_tag .= "<img src='templates/redshoemaniac/images/icon-print.png' alt='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' />";
$print_tag .= "</a>";
