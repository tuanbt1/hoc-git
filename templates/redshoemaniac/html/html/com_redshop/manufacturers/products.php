...
/* count total product*/
$string_totalproduct='1-'.count($manufacturer_products).' of '.count($manufacturer_products);
$template_desc = str_replace("{total_product}", $string_totalproduct, $template_desc);
