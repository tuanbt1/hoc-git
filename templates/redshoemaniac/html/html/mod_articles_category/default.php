...
<?php if ($grouped) : ?>
	...
	<li>
		<h4<?php echo $item_heading; ?>><?php echo $group_name; ?></h4<?php echo $item_heading; ?>>
		<ul class="list-striped">  <?php // Wright v.3: Added list-striped class ?>
			<?php foreach ($group as $item) : ?>
			    <li class="clearfix col-md-6">  <?php // Wright v.3: Added clearfix class ?>
				    <?php if ($item->displayDate) : ?>
						<span class="mod-articles-category-date">
						<!--<i class="icon-calendar"></i>-->  <?php // Wright v.3: Added icon ?>
						<?php echo $item->displayDate; ?></span>
					<?php endif; ?>
					<h4<?php echo $item_heading+1; ?>>
...
<?php else : ?>
	<?php foreach ($list as $item) : ?>
	    <li class="clearfix col-md-6">  <?php // Wright v.3: Added clearfix class ?>
	    <div class='img'>
	    	<img src='<?php echo json_decode($item->images)->image_intro;?>' alt='imageblog' />
	    </div>
	    <div class='content'>
		   	<h4 <?php echo $item_heading; ?>>
		   	<?php if ($params->get('link_titles') == 1) : ?>
			<a class="mod-articles-category-title <?php echo $item->active; ?>" href="<?php echo $item->link; ?>">
			<!--<i class="icon-file"></i>-->  <?php // Wright v.3: Added icon ?>
			<?php echo $item->title; ?>
