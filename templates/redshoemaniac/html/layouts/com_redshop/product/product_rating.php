...
<script type="text/javascript" language="javascript">
	...
	jQuery(document).ready(function ($) {
		$('#jform_username').attr("placeholder", "<?php echo JText::_('COM_REDSHOP_PRODUCT_RATING_USERNAME');?>");
		$('#jform_email').attr("placeholder", "<?php echo JText::_('COM_REDSHOP_PRODUCT_RATING_EMAIL');?>");
		$('#jform_title').attr("placeholder", "<?php echo JText::_('COM_REDSHOP_PRODUCT_RATING_SUBJECT');?>");
		$('#jform_comment').attr("placeholder", "<?php echo JText::_('COM_REDSHOP_PRODUCT_RATING_COMMENT');?>");
	});
</script>
<form name="productRatingForm" action="<?php echo JRoute::_('index.php?option=com_redshop&view=product_rating', false); ?>" method="post"
	...
	<div style='clear:both;'>
		<table class='table-reviewbox' cellpadding="3" cellspacing="3" border="0" width="100%">
			<tr>
				<td colspan="8">
					<table cellpadding="3" cellspacing="0" border="0">
						<tr>
							<td><a class='title-rateit'><?php echo JText::_('COM_REDSHOP_PRODUCT_RATING_TITLE');?></a></td>
							<td align="center">
