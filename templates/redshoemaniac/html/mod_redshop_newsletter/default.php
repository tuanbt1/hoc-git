...
<form method="post" action="" name="subscribeForm" onsubmit="return validation();">
	<div class="redshop_newsletter">
		<div class='redshop_newsletter_title'>
			<?php echo JText::_('COM_REDSHOP_NEWSLETTER_TITLE');?>
		</div>
		<div class='redshop_newsletter_desc'>
			<?php echo JText::_('COM_REDSHOP_NEWSLETTER_SUBSCRIPTION'); ?>
		</div>
		<div class="redshop_newsletter_input" style="display: none;">
		...
		<div class="redshop_newsletter_buttons">
			...
			<input style='display: none;' type="submit" name="unsubscribe" id="unsubscribe"
