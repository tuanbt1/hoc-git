...
<form action="<?php echo JRoute::_('index.php?option=com_redshop&view=search&Itemid=' . $Itemid); ?>" method="post"
	...
	<div class="product_search">
		...
		if ($showSearchField == 'yes')
		{
			...
			{
				?>
				<div class="product_search_input"><?php echo JText::_('COM_REDSHOP_KEYWORD'); ?> <?php } ?>
			<input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" onclick="this.value=''" class="inputbox"/>
		...
		{ ?>
			<input type="submit" name="Search" value=<?php echo JText::_('COM_REDSHOP_SEARCH'); ?> id="Search" class="button" />
		<?php } ?>
	</div>
