...
if (!$user->id)
{
	...
	{
		echo "<div class='wishls-noproduct'><div class='title'>" . JText::_('COM_REDSHOP_NO_PRODUCTS_IN_WISHLIST') . "</div><a href='".JURI::base()."index.php'>".JText::_('COM_REDSHOP_NO_PRODUCTS_IN_WISHLIST_BTN_BACK')."</a></div>";
	}
	echo "</div>";
}
else
{
	...
	if (count($wishlists) > 0)
	{
		...
		echo "<tr class='wl_headrow'><th class='colid'>#</th><th class='colname'>WishList</th><th class='colname'>Date</th><th class='colfunc'></th></tr>";
		}else{
		echo "<tr class='wl_headrow'><th class='colid'>#</th><th class='colname'>QuoteList</th><th class='colname'>Date</th><th class='colfunc'></th></tr>";
		}
		foreach ($wishlists as $wishlist)
		{
			$wishlist_link = JRoute::_("index.php?view=account&layout=mywishlist&wishlist_id=" . $wishlist->wishlist_id . "&option=com_redshop&wishls_name=" . $wishlist->wishlist_name . "&Itemid=" . $Itemid);
			...
			echo "<tr><td><a class='wl-id'>". $wishlist->wishlist_id ."</a></td><td><a class='wl-name' href=\"" . $wishlist_link . "\">" . $wishlist->wishlist_name . "</a></td>"
				. "<td><a class='wl-name' href=\"" . $wishlist_link . "\">".DATE("d.m.Y",$wishlist->cdate)."</a></td><td><a class='wl-func' href=\"" . $del_wishlist . "\">" . JText::_('COM_REDSHOP_DELETE') . "</a></td></tr>";
		}
