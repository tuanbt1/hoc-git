...
else
{
	...
	$print_tag = "<a class='printicon' href='#' onclick='window.open(\"$print_url\",\"mywindow\",\"scrollbars=1\",\"location=1\")' title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' ><img src=templates/redshoemaniac/images/icon-print.png  alt='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "' /></a>";
}

$quotation_template = str_replace("{print}", $print_tag, $quotation_template);
$quotation_template = str_replace("{username}", $user->username, $quotation_template);
