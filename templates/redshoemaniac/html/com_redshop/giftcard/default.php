...
if ($gid != 0)
{
	...
	if (strstr($template, "{giftcard_image}"))
	{
		...
		$thum_image .= "<img src='" . $linkimage . "' title='" . $detail->giftcard_name . "' alt='" . $detail->giftcard_name . "'>";
		$thum_image .= "</a>";
	...
	if (strstr($template, "{giftcard_loop_start}") && strstr($template, "{giftcard_loop_end}"))
	{
		...
		for ($i = 0; $i < count($detail); $i++)
		{
			...
			if (strstr($data_add, "{giftcard_image}"))
			{
				...
				{
					$thum_image = "<a href='" . $link . "'><img src='" . $linkimage . "' title='" . $detail[$i]->giftcard_name . "' alt='" . $detail[$i]->giftcard_name . "'></a>";
