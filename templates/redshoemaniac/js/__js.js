...
/*    $('.contactform').each(function(index, val) {
    ...
    $('.attribute_property .select-buttons').find('li:first-child').each(function(index, val) {
        ...
        if($(this).find('>a').html().toUpperCase()=='CHỌN COLOR'){//this name must be same with innerhtml element
            $(this).parent().addClass('box-color');
            $(this).addClass('box-color-title');
            $(this).find('>a').html('Màu:');
        }
        if($(this).find('>a').html().toUpperCase()=='CHỌN SIZE'){//this name must be same with innerhtml element
    ...
    $('.attribute_property .select-buttons li').find('>a').each(function(index, val) {
        ...
        if(temp_classname == "Kích thước:" || temp_classname == "Màu:" || temp_classname == "size:" || temp_classname == "color:" )
        {
           $(this).removeClass();
        }
    });
