...
$display_button = JText::_('MOD_REDSHOP_CART_CHECKOUT');
...
{
	$cartTotallbl   = JText::_('MOD_REDSHOP_CART_TOTAL');
...
<div class="mod_cart_main">
	<div class='mod-cart-wishlist-button'>
		<a href='index.php?option=com_redshop&view=wishlist&layout=viewwishlist&Itemid=171#wishlist'>wishlist</a>
	</div>
	<div class="mod_cart_top">
		<div class="mod_cart_title">
				<span class="mod_cart_title_total"><?php echo $cartTotalProduct ?></span>
		</div>
	</div>
	<div class="mod_cart_bottom" style='display: none;'>
		<div class="mod_cart_inner">
			<div class="mod_cart_total" id="mod_cart_total">
				...
				{
					$output = JText::_('MOD_REDSHOP_CART_EMPTY_CART');
				}
