...
$wishlist_name = '';
if (isset($_REQUEST['wishls_name'])) {
	$wishlist_name = $_REQUEST['wishls_name'];
}
...
if ($mail == 0)
{
	...
	{
		$wishlist_error="<div class='wishls-noproduct'><span>" . JText::_('COM_REDSHOP_NO_PRODUCTS_IN_WISHLIST') . "</span><a href='".JURI::base()."index.php'>GO BACK TO PRODUCTS</a></div>";
	}
	...
	$data      = str_replace('{wishls_name}', $wishlist_name, $data);
	$data      = str_replace('{error}', $wishlist_error, $data);
	$mail_link = '';
