...
$template_desc = str_replace("{quote_name}", $detail->firstname, $template_desc);
$template_desc = str_replace("{quote_email}", $detail->user_email, $template_desc);
$template_desc = str_replace("{quote_phone}", $detail->phone, $template_desc);
$template_desc = str_replace("{quote_address}", $detail->address, $template_desc);
$template_desc = str_replace("{quote_zipcode}", $detail->zipcode, $template_desc);
