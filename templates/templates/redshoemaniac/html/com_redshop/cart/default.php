...
$qlink = $url . 'index.php?option=com_redshop&view=quotation&for=true&return=1&Itemid=' . $Itemid;
$quotation_request = '<a href="' . $qlink . '"><input type=button class="greenbutton" value= "' . JText::_('COM_REDSHOP_REQUEST_QUOTATION') . '" /></a>';
