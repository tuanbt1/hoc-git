...
if (COMARE_PRODUCTS == 1)
{
						...
						if ($cid == $catid)
						{
							...
							<tr valign="top">
								<td width="100%" colspan='2'>
									<span><a class="comp_title"> href='<?php echo $link; ?>'
									         title='<?php echo $row->product_name; ?>'><?php echo $row->product_name; ?></a></span>
								</td>
							</tr>
							<tr>
								<td width="100%" colspan='2'>
									<span><a class='comp_delbtn' href='javascript:void(0);'
	...
	<div id="mod_compare">
		<a href="<?php echo JRoute::_('index.php?option=com_redshop&view=product&layout=compare&Itemid=206'. $cid_main) ?>"><?php echo JText::_('COM_REDSHOP_COMPARE'); ?></a>
	</div>
<?php
}
else
