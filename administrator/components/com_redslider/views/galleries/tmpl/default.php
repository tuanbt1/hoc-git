...
<script type="text/javascript">
	...
	submitbutton = function (pressbutton)
	{
		...
		{
			var r = confirm('<?php echo JText::_("COM_REDSLIDER_GALLERIES_DELETE")?>');
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th width="30" nowrap="nowrap">
					<?php echo JHTML::_('rsearchtools.sort', 'JSTATUS', 'g.published', $listDirn, $listOrder); ?>
				</th>
				<th width="1" align="center">
				</th>
				<th class="title" width="auto">
					<?php echo JHTML::_('rsearchtools.sort', 'COM_REDSLIDER_GALLERY', 'g.title', $listDirn, $listOrder); ?>
				</th>
				<th width="10" nowrap="nowrap">
					<?php echo JHTML::_('rsearchtools.sort', 'COM_REDSLIDER_ID', 'g.id', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		<?php foreach ($this->items as $i => $row) :
			...
			<tr>
				...
				<td>
					<?php if ($canEditState): ?>
						<?php echo JHtml::_('rgrid.published', $row->published, $i, 'galleries.', true, 'cb'); ?>
					<?php else: ?>
				...
				<td>
					<?php if ($row->checked_out) : ?>
						<?php
							echo JHtml::_('rgrid.checkedout', $i, $editor->name, $row->checked_out_time, 'galleries.', $canCheckin);
						?>
					<?php endif; ?>
				</td>
				<td>
